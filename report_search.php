                    ...
                    <!--        <li>
						...
						<form method="POST" action="report_search.php" class="form-inline">
                                <div class="control-group">
                                    <div class="controls">
                                        <div class="col-md-3">
                                            <input type="date" style="color:black;" value="<?php echo (isset($_POST['datefrom'])) ? $_POST['datefrom']: ''; ?>" name="datefrom" class="form-control has-feedback-left" placeholder="Date From" aria-describedby="inputSuccess2Status4" required />
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <div class="col-md-3">
                                            <input type="date" style="color:black;" value="<?php echo (isset($_POST['dateto'])) ? $_POST['dateto']: ''; ?>" name="dateto" class="form-control has-feedback-left" placeholder="Date To" aria-describedby="inputSuccess2Status4" required />
                                            <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                            <span id="inputSuccess2Status4" class="sr-only">(success)</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="controls">
                                        <div class="col-md-2">
											<select class="form-control" name="status" style="color:black;">
                                                ...
                                                <option value="reserved" <?php echo ($_POST['status']=='reserved') ? 'selected' : ''; ?>>Reserved Book</option>
												<option value="borrowed" <?php echo ($_POST['status']=='borrowed') ? 'selected' : ''; ?>>Borrowed Book</option>
												<option value="returned" <?php echo ($_POST['status']=='returned') ? 'selected' : ''; ?>>Returned Book</option>
											</select>
                                        </div>
                                    </div>
                                </div>
				...
				-->
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
                            ...
                            $dateto = $_POST['dateto'];
                            $status = (($_POST['status']=='All') ? "(detail_action='Borrowed Book' OR detail_action='Returned Book' OR detail_action='Reserved Book')" : (($_POST['status']=='borrowed') ? "detail_action='Borrowed Book'" : (($_POST['status']=='returned') ? "detail_action='Returned Book'" : "detail_action='Reserved Book'")));
							$result= mysqli_query($con,"select * from report 
							INNER JOIN book ON report.book_id = book.book_id 
							INNER JOIN user ON report.user_id = user.user_id WHERE report.date_transaction BETWEEN '".$_POST['datefrom']." 00:00:01' and '".$_POST['dateto']." 23:59:59' AND $status  
